      ...
      <section className="pt-32 pb-20 bg-card">
        <div className="container mx-auto px-4">
          <div className="max-w-3xl">
            <h1 className="text-sm font-mono uppercase tracking-wider text-primary mb-4">Partner With Us</h1>
            <h2 className="text-4xl md:text-5xl lg:text-6xl font-bold text-secondary mb-6">Partnerships</h2>
